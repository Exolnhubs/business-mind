...
-- Covers 13 Arab countries with lat/lng/location for geo search.
--
-- PREREQUISITES:
...
BEGIN
  ...
  (gen_random_uuid(), org1, cat_tech,
   ...
   24.7626, 46.6400, ST_SetSRID(ST_MakePoint(46.6400, 24.7626), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_music,
   ...
   24.7500, 46.7213, ST_SetSRID(ST_MakePoint(46.7213, 24.7500), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_food,
   ...
   21.5433, 39.1728, ST_SetSRID(ST_MakePoint(39.1728, 21.5433), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_sports,
   ...
   21.4924, 39.1672, ST_SetSRID(ST_MakePoint(39.1672, 21.4924), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_business,
   ...
   26.2887, 50.1484, ST_SetSRID(ST_MakePoint(50.1484, 26.2887), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_arts,
   ...
   25.1836, 55.2497, ST_SetSRID(ST_MakePoint(55.2497, 25.1836), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_tech,
   ...
   'ADNEC', 'Abu Dhabi', 'AE',
   24.4179, 54.4290, ST_SetSRID(ST_MakePoint(54.4290, 24.4179), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_outdoor,
   ...
   'Two-day desert camping with dune bashing, star-gazing, and falconry.',
   'تجربة تخييم في الصحراء لمدة يومين مع ركوب الكثبان الرملية ومشاهدة النجوم والصقارة.',
   'Al Qudra Desert', 'Dubai', 'AE',
   24.9856, 55.2085, ST_SetSRID(ST_MakePoint(55.2085, 24.9856), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_arts,
   ...
   30.0367, 31.2243, ST_SetSRID(ST_MakePoint(31.2243, 30.0367), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_education,
   ...
   'Student-led science projects and workshops at the Bibliotheca Alexandrina.',
   'مشاريع علمية وورش عمل بقيادة الطلاب في مكتبة الإسكندرية.',
   'Bibliotheca Alexandrina', 'Alexandria', 'EG',
   31.2089, 29.9060, ST_SetSRID(ST_MakePoint(29.9060, 31.2089), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_music,
   ...
   29.9792, 31.1342, ST_SetSRID(ST_MakePoint(31.1342, 29.9792), 4326)::geography,
   '2026-07-03 20:00:00+02', '2026-07-04 02:00:00+02',
  ...
  (gen_random_uuid(), org1, cat_outdoor,
   ...
   30.3197, 35.4795, ST_SetSRID(ST_MakePoint(35.4795, 30.3197), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_business,
   ...
   'شركات ناشئة في مراحلها المبكرة تعرض أفكارها على المستثمرين.',
   'King Hussein Business Park', 'Amman', 'JO',
   31.9775, 35.8524, ST_SetSRID(ST_MakePoint(35.8524, 31.9775), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_family,
   ...
   29.3696, 47.9821, ST_SetSRID(ST_MakePoint(47.9821, 29.3696), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_health,
   ...
   29.3358, 47.9280, ST_SetSRID(ST_MakePoint(47.9280, 29.3358), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_sports,
   ...
   'Aspire Zone', 'Doha', 'QA',
   25.2631, 51.4400, ST_SetSRID(ST_MakePoint(51.4400, 25.2631), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_education,
   ...
   25.2956, 51.4396, ST_SetSRID(ST_MakePoint(51.4396, 25.2956), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_music,
   ...
   26.2268, 50.6050, ST_SetSRID(ST_MakePoint(50.6050, 26.2268), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_food,
   ...
   26.2173, 50.5870, ST_SetSRID(ST_MakePoint(50.5870, 26.2173), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_outdoor,
   ...
   23.5759, 58.5303, ST_SetSRID(ST_MakePoint(58.5303, 23.5759), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_arts,
   ...
   23.6059, 58.5926, ST_SetSRID(ST_MakePoint(58.5926, 23.6059), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_health,
   ...
   17.0082, 54.0924, ST_SetSRID(ST_MakePoint(54.0924, 17.0082), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_arts,
   ...
   33.8938, 35.5218, ST_SetSRID(ST_MakePoint(35.5218, 33.8938), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_food,
   ...
   33.8968, 35.5098, ST_SetSRID(ST_MakePoint(35.5098, 33.8968), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_music,
   ...
   'Multi-day outdoor festival celebrating Moroccan and North African artists.',
   'مهرجان موسيقي متعدد الأيام يحتفي بالفنانين المغاربة وشمال أفريقيا.',
   'Anfa Park', 'Casablanca', 'MA',
   33.5984, -7.6328, ST_SetSRID(ST_MakePoint(-7.6328, 33.5984), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_outdoor,
   ...
   31.3667, -7.9031, ST_SetSRID(ST_MakePoint(-7.9031, 31.3667), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_education,
   ...
   31.6295, -8.0088, ST_SetSRID(ST_MakePoint(-8.0088, 31.6295), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_tech,
   ...
   36.8510, 10.2019, ST_SetSRID(ST_MakePoint(10.2019, 36.8510), 4326)::geography,
  ...
  (gen_random_uuid(), org2, cat_education,
   ...
   33.3360, 44.3862, ST_SetSRID(ST_MakePoint(44.3862, 33.3360), 4326)::geography,
  ...
  (gen_random_uuid(), org1, cat_arts,
   ...
   31.9038, 35.2034, ST_SetSRID(ST_MakePoint(35.2034, 31.9038), 4326)::geography,
